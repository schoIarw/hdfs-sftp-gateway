...
- `hfg-manager-api/target/hfg-manager-api-0.1.10.jar`
- `hfg-gateway-app/target/hfg-gateway-app-0.1.10.jar`
- `hfg-common-contract/target/hfg-common-contract-0.1.10-bootstrap.jar`（CA、Manager 证书和快照密钥一键初始化）
...
- [HFG 0.1.10 release notes](docs/release-notes-v0.1.10.md)
