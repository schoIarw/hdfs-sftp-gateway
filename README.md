...
- `hfg-manager-api/target/hfg-manager-api-0.1.6.jar`
- `hfg-gateway-app/target/hfg-gateway-app-0.1.6.jar`
- `hfg-common-contract/target/hfg-common-contract-0.1.6-bootstrap.jar`（CA、Manager 证书和快照密钥一键初始化）
